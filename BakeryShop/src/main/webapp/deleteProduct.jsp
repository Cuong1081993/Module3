                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Delete Customer</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
...
<%--                            <input type="hidden" name="id" value="">--%>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text"  id="image" readonly name="image" class="form-control"  value="${requestScope.product.getImage()}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 control-label">Price</label>
                                <div class="col-md-10">
                                    <input type="number" readonly class="form-control" name = "price" value="${requestScope.product.getPrice()}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 control-label">Title</label>
                                <div class="col-md-10">
                                    <input type="text" readonly class="form-control" name = "title" value="${requestScope.product.getTitle()}">
                                </div>
                            </div>
                            <div class="form-group row">
