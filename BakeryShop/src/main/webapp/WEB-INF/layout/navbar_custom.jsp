...
<%--          <img src="/assets\images\flags\germany.jpg" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Germ</span>--%>
<%--        </a>--%>
      </div>
    </li>
      ...
      <div class="dropdown-menu dropdown-menu-right dropdown-lg">
        ...
        <div class="slimscroll noti-scroll">
          ...
          <a href="javascript:void(0);" class="dropdown-item notify-item active">
            ...
            <p class="notify-details">Hello Customer
    ...
    <li class="dropdown notification-list">
      <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
        ...
        <span class="pro-user-name ml-1">
                                Mr.Cuong <i class="mdi mdi-chevron-down"></i>
                            </span>
      </a>
  ...
  <div class="logo-box">
    <a href="/index.jsp" class="logo text-center">
                        <span class="logo-lg">
                            <img src="https://o.remove.bg/downloads/08dac47a-75ae-4dc1-b147-b4f4ef144f45/bakery-logo-template_441059-123-removebg-preview.png?w=2000" alt="" height="80">
