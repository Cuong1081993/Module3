                    ...
                    <div class="col-sm-12">
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name = "name" value="${requestScope.product.getNameProduct()}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 control-label" for="address">Price</label>
                                <div class="col-md-10">
                                    <input type="text"  id="address"  name="price" class="form-control"  value="${requestScope.product.getPrice()}">
                                </div>
                            </div>
                            <div class="form-group row">
